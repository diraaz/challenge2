...
const psecore = document.getElementById('psecore');
const csecore = document.getElementById('csecore');
let psecoreCount = 1;
let csecoreCount = 1;
...
function win() {
    ...
    resultObject();
    psecore.innerHTML = psecoreCount++;
...
function lose() {
    console.log("COM WIN");
    resultObject();
    csecore.innerHTML = csecoreCount++;
